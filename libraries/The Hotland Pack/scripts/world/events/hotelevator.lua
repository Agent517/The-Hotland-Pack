...
function Elevator:init(data)
    ...
    self.background = data.properties["background_1"] or "bg/elevator"
    self.elevatordoorleft = data.properties["backgrounddoors_1"] or "bg/elevator_door_left"
    self.elevatordoorright = data.properties["backgrounddoors_2"] or "bg/elevator_door_right"
...
function Elevator:draw()
    ...
    love.graphics.draw(Assets.getTexture(self.background), 0, 0, 0, 1, 1)
    ...
    love.graphics.draw(Assets.getTexture(self.elevatordoorleft), (265 - self.doorx), 352, 0, 2, 2)
    love.graphics.draw(Assets.getTexture(self.elevatordoorright), (318 + self.doorx), 352, 0, 2, 2)
    -- local x1 = (318)
    -- local y1 = 352
    -- local x2 = (318)
    -- local y2 = 500
